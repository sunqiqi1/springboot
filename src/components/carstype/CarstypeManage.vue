<template>
  <div>
    <div style="margin-bottom: 5px">
      <el-input v-model="name" placeholder="请输入车类名称" suffix-icon="el-icon-search" style="width: 200px"
    ...
    >
      ...
      <el-table-column prop="name" label="车类名称" width="140">
      </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="80px">
        <el-form-item label="车类名称" prop="name">
          <el-col :span="15">
...
export default {
  ...
  methods:{
    ...
    del(id){
      console.log(id)
      this.$axios.get(this.$httpUrl+'/type/del?id='+id).then(res=>res.data).then(res=>{
        console.log(res)
        if(res.code==200){
          this.$message({
            message: '操作成功',
